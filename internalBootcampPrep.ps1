...
try {
    Connect-MgGraph -Scopes "User.ReadWrite.All,Policy.ReadWrite.ConditionalAccess, Policy.Read.All, Domain.ReadWrite.All, AppRoleAssignment.ReadWrite.All" -NoWelcome -ErrorAction Stop
